...
class ExpressionParser ( Parser ):
    ...
    def expr(self, _p:int=0):
        ...
        try:
            ...
            localctx = ExpressionParser.TermExprContext(self, localctx)
            self._ctx = localctx
            _prevctx = localctx
    ...
    class FactorTermContext(TermContext):
        ...
        def accept(self, visitor:ParseTreeVisitor):
            if hasattr( visitor, "visitFactorTerm" ):
                return visitor.visitFactorTerm(self)
            else:
                return visitor.visitChildren(self)
    ...
    def term(self, _p:int=0):
        ...
        try:
            self.enterOuterAlt(localctx, 1)
            localctx = ExpressionParser.FactorTermContext(self, localctx)
            self._ctx = localctx
            _prevctx = localctx
            ...
            while _alt!=2 and _alt!=ATN.INVALID_ALT_NUMBER:
                if _alt==1:
                    if self._parseListeners is not None:
                        self.triggerExitRuleEvent()
                    _prevctx = localctx
                    localctx = ExpressionParser.MulDivContext(self, ExpressionParser.TermContext(self, _parentctx, _parentState))
    ...
    def factor(self):
        ...
        try:
            ...
            if token in [7]:
                localctx = ExpressionParser.NumberContext(self, localctx)
                self.enterOuterAlt(localctx, 1)
                self.state = 28
